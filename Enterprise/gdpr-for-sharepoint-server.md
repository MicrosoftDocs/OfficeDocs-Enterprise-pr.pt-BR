...
No SharePoint Server 2013 e no SharePoint Server 2016, históricos de consultas e consultas "favoritas" expiram automaticamente após 365 dias. Se um usuário deixar sua organização, será possível remover referências ao nome dele do histórico de consultas usando as etapas abaixo.

As consultas SQL a seguir aplicam-se ao SharePoint 2013 e ao SharePoint 2016 e permitem:
...
O SharePoint Server 2013 e o SharePoint Server 2016 excluem automaticamente os registros de uso após 3 anos. Você pode excluir esses registros manualmente usando o procedimento a seguir:
