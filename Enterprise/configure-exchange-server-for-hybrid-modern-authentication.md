...
Forçar os usuários do Outlook a autenticação moderna  
[Requisitos de configuração de autenticação moderna para transição do Office 365 dedicada/ITAR para o vNext](modern-authentication-configuration.md)
