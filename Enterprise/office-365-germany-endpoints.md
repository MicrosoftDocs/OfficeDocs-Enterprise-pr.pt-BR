...
|||
|:-----|:-----|
|**Última atualização:** 06/28/2019- ![](media/5dc6bb29-25db-4f44-9580-77c735492c4b.png) [assinatura de log de alteração](https://endpoints.office.com/version/Germany?allversions=true&format=rss&clientrequestid=b10c5ed1-bad1-445f-b386-b919946339a7) de RSS |**Baixar:** todos os destinos obrigatórios e opcionais em uma lista [no formato em JSON](https://endpoints.office.com/endpoints/Germany?clientrequestid=b10c5ed1-bad1-445f-b386-b919946339a7).  <br/> |
...
Os pontos de extremidade são agrupados em quatro áreas de serviço. As três primeiras áreas de serviço podem ser selecionadas independentemente para conectividade. A quarta área de serviço é uma dependência comum (chamada Microsoft 365 Common e Office) e deve sempre ter conectividade de rede.
