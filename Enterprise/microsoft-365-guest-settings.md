...
|Classificação de conteúdo Giphy|Moderado|Quando definido como **Permitir todo o conteúdo**, os convidados podem inserir todos os Giphys em chats, independentemente da classificação de conteúdo. Quando definido como **Moderado**, os convidados podem inserir Giphys em chats, mas o conteúdo adulto será restringido moderadamente. Quando definido como **Estrito**, os convidados podem inserir Giphys em chats, mas o conteúdo adulto não poderá ser inserido.|
