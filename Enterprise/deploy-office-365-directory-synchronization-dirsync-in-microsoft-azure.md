...
# Implantar a DirSync (sincronização de diretórios) do Office 365 no Microsoft Azure
...
- [Visão geral da implantação da sincronização de diretório do Office 365 no Azure ](deploy-office-365-directory-synchronization-dirsync-in-microsoft-azure.md#Overview)
    
- [Planejar a hospedagem de um servidor DirSync do Office 365 no Azure](deploy-office-365-directory-synchronization-dirsync-in-microsoft-azure.md#PlanningVirtual)
    
- [Roteiro de implantação](deploy-office-365-directory-synchronization-dirsync-in-microsoft-azure.md#DeploymentRoadmap)
    
> [!IMPORTANT]
> Essa solução requer conectividade entre sua rede local e sua Rede Virtual do Azure. Para saber mais, confira o artigo [Conectar uma rede local a uma rede virtual do Microsoft Azure](81190961-5454-4a5c-8b0e-6ae75b9fb035.md). 
...
## Visão geral da implantação da sincronização de diretório do Office 365 no Azure
<a name="Overview"> </a>
...
1. Criar uma rede virtual do Azure e estabelecer uma conexão VPN de site a site para a sua rede local. Para saber mais, confira o artigo [Conectar uma rede local a uma rede virtual do Microsoft Azure](81190961-5454-4a5c-8b0e-6ae75b9fb035.md).
...
1. Criar uma Máquina Virtual do Azure para executar o Azure AD Connect.
    
2. Instalar e configurar o [Azure AD Connect](https://www.microsoft.com/download/details.aspx?id=47594).
...
## Planejar a hospedagem de um servidor DirSync do Office 365 no Azure
...
- Examine o conteúdo de planejamento relacionado em [Planejar sua rede virtual do Azure](81190961-5454-4a5c-8b0e-6ae75b9fb035.md#PlanningVirtual).
    
- Verifique se você atende a todos os [pré-requisitos](http://technet.microsoft.com/library/81190961-5454-4a5c-8b0e-6ae75b9fb035%28v=office.15%29.aspx#Prerequisites) para configurar a Rede Virtual do Azure.
...
- Provisione uma Máquina Virtual do Azure que executa o Azure AD Connect para sincronizar sua floresta local do AD do Windows Server com o Office 365.
    ...
    Você deve ter as credenciais (nomes e senhas) para a conta de administrador corporativo do AD do Windows Server e uma conta de Administrador do Active Directory do Azure.
...
Para criar e configurar a rede virtual do Azure, conclua a [Fase 1: Preparar sua rede local](http://technet.microsoft.com/library/81190961-5454-4a5c-8b0e-6ae75b9fb035%28v=office.15%29.aspx#Phase1) e a[Fase 2: Criar a rede virtual entre locais no Azure](http://technet.microsoft.com/library/81190961-5454-4a5c-8b0e-6ae75b9fb035%28v=office.15%29.aspx#Phase2) no roteiro de implantação de[Conectar uma rede local a uma rede virtual do Microsoft Azure](81190961-5454-4a5c-8b0e-6ae75b9fb035.md).
...
### Atribuir locais e licenças aos usuários no Office 365
...
[Conectar uma rede local a uma rede virtual do Microsoft Azure](81190961-5454-4a5c-8b0e-6ae75b9fb035.md)
#### 
