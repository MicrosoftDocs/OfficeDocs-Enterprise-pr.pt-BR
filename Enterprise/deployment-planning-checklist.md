...
| Coletar o número e o tamanho das caixas de correio (incluindo caixas de correio compartilhadas e salas de conferência) |||||
| Coletar versões e configurações do cliente (navegadores, sistemas operacionais, aplicativos do Office, versões móveis e assim por diante) |||||
| Coletar detalhes sobre suas configurações de rede (hosts DNS, configuração de proxy e/ou firewall, conectividade com a Internet) |||||
| Coletar informações sobre locais de armazenamento de arquivos (compartilhamentos de arquivos, armazenamento de arquivos na intranet) |||||
| Coletar detalhes sobre os sites de intranet que você planeja migrar |||||
| Coletar sistemas de reunião online e mensagens instantâneas que você planeja migrar |||||
...
|Com ferramentas e orientações da Microsoft: |||||
| Limpar contas do Active Directory ( [orientação](https://go.microsoft.com/fwlink/?LinkId=534825) e [ferramenta](https://go.microsoft.com/fwlink/?LinkId=534826)) |||||
| Preparar seus dados para uma migração ( [emails](https://go.microsoft.com/fwlink/?LinkId=534823) e [arquivos](https://go.microsoft.com/fwlink/?LinkId=534824)) |||||
...
| Se preparar opcionalmente [para logon único](https://go.microsoft.com/fwlink/?LinkId=534831) |||||
|Preparar sua organização |||||
|[Preparar o Service Desk](https://fasttrack.microsoft.com/office) para a migração futura |||||
| Testar a implantação e o processo de migração opcional |||||
