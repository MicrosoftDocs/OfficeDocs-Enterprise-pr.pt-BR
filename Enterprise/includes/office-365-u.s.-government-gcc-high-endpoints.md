...
4 | Padrão<BR>Obrigatório | Sim | `attachments.office365-net.us, autodiscover.<tenant>.mail.onmicrosoft.com, autodiscover.<tenant>.onmicrosoft.com` | **TCP:** 443, 80
...
10  | Padrão<BR>Obrigatório | Não | `admin.onedrive.us, odc.officeapps.live.com, officeclient.microsoft.com, oneclient.sfx.ms, wns.windows.com` | **TCP:** 443, 80
...
14  | Padrão<BR>Obrigatório | Não | `mscrl.microsoft.com, secure.aadcdn.microsoftonline-p.com` | **TCP:** 443
...
17  | Permitir<BR>Obrigatório | Sim | `*.osi.office365.us`<BR>`52.127.240.0/21` | **TCP:** 443
