...
|![texto explicativo de magenta 7](media/ff15e89c-d2fd-4614-9838-5e18287d578b.png)|(Opção B) Usando a ferramenta e o processo de importação do Microsoft 365, importe os arquivos PST coletados para o Exchange Online.  <br/> |
...
|![texto explicativo 11](media/e59ab403-2f19-497a-92a5-549846dded66.png)|Realize o conteúdo de descoberta eletrônica no Microsoft 365.  <br/> |
...
|Microsoft 365 E3 com Exchange Online e SharePoint Online (necessário para a opção B)  <br/> |Para se inscrever em uma assinatura do Microsoft 365 E3, confira [assinatura do microsoft 365 E3](https://www.microsoft.com/microsoft-365/enterprise-e3-business-software?activetab=pivot%3aoverviewtab).  <br/> |
...
|Descoberta eletrônica no Microsoft 365 para SharePoint Online e Exchange Online  <br/> |Para configurar a descoberta eletrônica no Microsoft 365, consulte [configurar um centro de descoberta eletrônica no SharePoint Online](https://go.microsoft.com/fwlink/p/?LinkId=613628).  <br/> |
...
|17   <br/> |**$ConnectionURI** precisa ser definido para seu próprio servidor. <br/> > [!IMPORTANT]> certifique-se de que o **$ConnectionURI** aponta para um local http, e não HTTPS. Ele não funcionará com https:.          |Obrigatório  <br/> |
...
Todas as outras etapas não são específicas desta solução. São tarefas administrativas padrão que você executa no SharePoint 2013, no Microsoft 365 e no Azure. Há itens que esta solução não fornece orientações que você precisará para trabalhar com base nas necessidades da sua empresa, como:
...
2. Quando a coleção estiver concluída, abra a pasta da coleção e navegue até a pasta _Log. Na pasta _Log, você verá o seguinte:
  ...
  - Um arquivo XML para cada unidade local no computador do usuário, por exemplo **A.xml** **C.xml**. Esses arquivos contêm as unidades de estoque que são nomeadas após e são usadas para a operação do Robocopy.
...
- Para colocar os arquivos PST coletados no Exchange Online, siga os procedimentos no arquivo importar arquivos no Microsoft 365 por meio de [upload de rede](https://docs.microsoft.com/microsoft-365/compliance/use-network-upload-to-import-pst-files).
