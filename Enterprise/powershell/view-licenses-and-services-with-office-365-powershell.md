...
- **SkuPartNumber:** Mostrar os planos de licenciamento disponíveis para sua organização > por exemplo, `ENTERPRISEPACK` é o nome do sistema para Office 365 Enterprise E3.
